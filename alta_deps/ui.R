                                           ...
                                           conditionalPanel("input.forma=='Manual'",
                                                            ...
                                                            conditionalPanel("input.tipo == 'With taxa'",
                                                                             radioButtons("sitaxa", "Type of living being", choices=trae_taxa_king()$kingdom, selected = character(0)),
                                                                                          autocomplete_input("div", "Division/Phylum", options=NA, create = TRUE),
                                                                                          autocomplete_input("fam", "Family", options=NA, create = TRUE),
                                                                                          autocomplete_input("gen", "Genus", options=NA, create = TRUE),
                                                                                          autocomplete_input("spec", "Species", options=NA, create = TRUE),
                                                                                          autocomplete_input("var", "Variety", options=NA, create = TRUE),
                                                                                          autocomplete_input("fdevida", "Life form", options=NA, create = TRUE),
                                                                                          autocomplete_input("vida", "Life span", options=NA, create = TRUE),
                                                                                          autocomplete_input("proven", "Provenance", options=NA, create = TRUE),
                                                                                          # autocomplete_input("nlocal", "Local name", options=NA),
                                                                                          autocomplete_input("gf", "Functional group", options=NA, create = TRUE)
                                                            ),
