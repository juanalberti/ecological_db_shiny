                             ...
                             div(id="form",
                                 ...
                                 conditionalPanel('input.format == "wide" || input.format == "long"',
                                                  ...
                                                  conditionalPanel('input.format == "long"',
                                                                   ...
                                                                   radioButtons("um_long", "Measurement unit of the dependent variable type:",
                                                                                choices=c(trae_tv()$unidad_medida,
                                                                                          if(length(trae_tv()$unidad_medida)==0){NA})),
                                                                   selectInput("obs_long", "Description for variable type", choices = character(0)),
